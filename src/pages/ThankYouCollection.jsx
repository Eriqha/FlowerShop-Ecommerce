// src/pages/ThankYouCollection.jsx
...
const ThankYouCollection = () => {
  const [products, setProducts] = useState([]);
  const { addToCart } = useContext(CartContext);

  useEffect(() => {
    API.get('/products', { params: { categories: 'thank-you' } })
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'left', color: '#fff' }}>
          ...
          <p className="fade-slide-up" style={{ maxWidth: '500px', marginTop: '10px', fontSize: '1.2rem' }}>
            Show gratitude with our beautiful thank you bouquets.
          </p>
        </div>
      </div>
...
export default ThankYouCollection;
