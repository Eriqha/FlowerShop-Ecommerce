// src/pages/SympathyFuneralCollection.jsx
...
const SympathyFuneralCollection = () => {
  const [products, setProducts] = useState([]);
  const { addToCart } = useContext(CartContext);

  useEffect(() => {
    API.get('/products', { params: { categories: 'sympathy-funeral' } })
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'left', color: '#fff' }}>
          ...
          <p className="fade-slide-up" style={{ maxWidth: '500px', marginTop: '10px', fontSize: '1.2rem' }}>
            Offer comfort and condolences with elegant arrangements.
          </p>
        </div>
      </div>
...
export default SympathyFuneralCollection;
