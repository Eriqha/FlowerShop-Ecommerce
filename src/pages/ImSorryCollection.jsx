// src/pages/ImSorryCollection.jsx
...
const ImSorryCollection = () => {
  const [products, setProducts] = useState([]);
  const { addToCart } = useContext(CartContext);

  useEffect(() => {
    API.get('/products', { params: { categories: 'im-sorry' } })
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'left', color: '#fff' }}>
          ...
          <p className="fade-slide-up" style={{ maxWidth: '500px', marginTop: '10px', fontSize: '1.2rem' }}>
            Express your apologies with thoughtful floral arrangements.
          </p>
        </div>
      </div>
...
export default ImSorryCollection;
