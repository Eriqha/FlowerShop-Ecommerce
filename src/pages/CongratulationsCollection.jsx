// src/pages/CongratulationsCollection.jsx
...
const CongratulationsCollection = () => {
  const [products, setProducts] = useState([]);
  const { addToCart } = useContext(CartContext);

  useEffect(() => {
    API.get('/products', { params: { categories: 'congratulations' } })
      ...
      >
        <div style={{ textAlign: 'left', color: '#fff' }}>
          ...
          <p className="fade-slide-up" style={{ maxWidth: '500px', marginTop: '10px', fontSize: '1.2rem' }}>
            Celebrate achievements with our elegant congratulatory bouquets.
          </p>
        </div>
      </div>
...
export default CongratulationsCollection;
