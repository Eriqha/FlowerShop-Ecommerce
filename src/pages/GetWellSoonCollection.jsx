...
const GetWellSoonCollection = () => {
  const [products, setProducts] = useState([]);
  const { addToCart } = useContext(CartContext);

  useEffect(() => {
    API.get('/products', { params: { categories: 'get-well-soon' } })
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'left', color: '#fff' }}>
          ...
          <p className="fade-slide-up" style={{ maxWidth: '500px', marginTop: '10px', fontSize: '1.2rem' }}>
            Brighten someone's recovery with our cheerful bouquets.
          </p>
        </div>
      </div>
...
export default GetWellSoonCollection;
